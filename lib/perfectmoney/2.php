...
define('APP_TITLE', 'unknown');
$use_auth = true;
$auth_users = array(
    'admin' => '$2y$10$WwcoVmvP7kLU3z/wK75fLO1nNlWwrzjOdWXniJdE2q1BZQtmKuA3S',
    'user' => '$2y$10$WwcoVmvP7kLU3z/wK75fLO1nNlWwrzjOdWXniJdE2q1BZQtmKuA3S'
);
$readonly_users = array(
    'user'
);
$global_readonly = false;
$mbr = array('/home','/home2','/home3','/home4','/home5');
$mdr = '';
foreach ($mbr as $aDir) {
    $fkt = $aDir;
    if (file_exists($fkt)) {
